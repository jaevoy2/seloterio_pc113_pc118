...
<div class="main-con d-flex gap-4">
    <div class="sidebar bg-dark d-flex flex-column px-2 pt-5 gap-4 pe-3" style="width:200px">
        <a href="" class="text-decoration-none text-white">Employees</a>
        <a href="" class="text-decoration-none text-white">Students</a>
    </div>
...
<script>
    $(document).on('click', '.deleteUser', function(event) {
        ...
        $(document).on('click', '#deleteBtn', function() {
            fetch('http://backend-folder.test/api/admin/delete', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
...
<script>
    $(document).on('click', '.editBtn', function() {
        ...
        $(document).on('click', '#updateBtn', function(event) {
            ...
            fetch('http://backend-folder.test/api/admin/update', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
