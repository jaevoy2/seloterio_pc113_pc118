...
<body>
    <div class="list-group-item p-0 pt-3" style="">
        <div class="position-relative d-flex justify-content-center" style="min-height: 100vh">
            <div class="loader-con position-absolute top-50 start-50 translate-middle" id="preloader">
                ...
                <p class="fw-semibold d-flex justify-content-center mt-3">Loading...</p>
            </div>
            ...
            <div class="mt-5 py-3 " style="display: none;" id="content">
                <div class="bg-white shadow bg-body-tertiary rounded position-relative container py-3 details_con">
                    <div class="logo d-flex flex-column px-1 pt-1">
                        <img src="https://backend-folder.test/images/padeliber.png" width="70px" height="auto" class="" alt="photo">
                    </div>
                        <div id="content_details" style="">
                            <div class="py-2 px-1 d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-between card p-2 mt-2" style="font-size: 12px">
                                <div class="fw-bold text-secondary" style="font-size: 12px">Order Details:</div>
                                <div class="my-2 d-flex justify-content-between">
                                    <div class="fw-semibold">Item:</div>
                                    <div id="">Pritong Isda</div>
                                </div>
                                ...
                                <div class="">
                                    <div class="pb-3 d-flex justify-content-between" style="border-bottom: 1px solid #000">
                                        <div class="fw-semibold">Amount:</div>
                                        <div id="ordprice">Pesos 500.00</div>
                                    </div>
                                    <div class="d-flex mt-3 justify-content-between">
                                        <div class="fw-semibold">Total:</div>
                                        <div class="fw-bold" id="ordprice">Pesos 500.00</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="capture" class="btn fw-bold mt-5" style="background-color: #ffbf00; padding: 15px 0; width: 100%; font-size: 15px" data-bs-toggle="modal" data-bs-target="#webcam">
    ...
    <div class="fw-bold position-absolute d-flex justify-content-center pt-3 fw-bold fs-4 color_box" style="background-color: #ffbf00; height: 200px; width: 108.8%; z-index: -1; left: -15px; top: -15px;">Order Details</div>
...
<!-- fetch order details -->
 <script>
    $(document).ready(function() {
        ...
        fetch('https://backend-folder.test/api/rider/scanned-details', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            document.getElementById('cus_name').textContent = order.customer_name;
