                ...
                <div class="position-relative" style="min-height:400px">
                    ...
                    <div class="mt-4 py-3" style="display: none;" id="content">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="my-delivery.php" class="text-decoration-none text-dark" style="font-size: 13px">My Deliveries</a>
                                </li>
                        ...
                        <div class="bg-white shadow bg-body-tertiary rounded position-relative container py-3">
                                ...
                                <div class="pt-2">
                                    <div class="p-3">
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            <div class="fw-semibold" style="font-size: 20px" id="order_id"></div>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <div class="d-flex gap-2">
                                                <div class="text-secondary fw-semibold" style="font-size: 13px">Status:</div>
                                                <div class="fw-semibold" style="font-size: 13px" id="ord_status"></div>
                                            </div>
                                            <a href="my-delivery.php" class="btn btn-warning btn-sm fw-semibold" style="font-size: 15px;">Back</a>
                                        </div>
                                        <div class="d-flex gap-3">
                                            <div class="ord_details d-flex flex-row justify-content-between card p-3" style="width: 60%">
                                                <div class="">
                                                    <div class="fw-semibold">Product</div>
                                                    <div id="ord_name">Pritong Isda</div>
                                                </div>
                                                <div class="">
                                                    <div class="pb-3" style="border-bottom: 1px solid #000">
                                                        <div class="fw-semibold">Amount</div>
                                                        <div id="price">Pesos 500.00</div>
                                                    </div>
                                                    <div class="d-flex gap-2">
                                            ...
                                            <div class="customer_detail card" style="width: 40%">
                            ...
                            <div id="scanBtn" class="align-items-center p-2 position-absolute fw-semibold bottom-0 end-0 shadow rounded" style="display: none; cursor: pointer; font-size: 13px;background-color: #ffbf00; border-radius: 5px" data-bs-toggle="modal" data-bs-target="#scannerModal">
                            ...
                            <div class="modal fade" tabindex="-1" id="scannerModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="d-flex justify-content-center p-3">
                                            <div class="qrReader" id="qrReader" style="width: 400px"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).on('click', '#scanBtn', function() {
            ...
            .then(data => {
                ...
                function startScanner() {
                    ...
                    scanner.render(function onScan(decodeText, decodeResult) {
                        try{
                            ...
                            if(orderId == id) {
                                ...
                                alert('Qrcode is invalid');
                                scanner.clear().then(startScanner);
                            }
                        }catch(e) {
