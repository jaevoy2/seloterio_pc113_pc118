                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <a class="text-decoration-none text-dark" style="font-size: 13px" href="">History</a>
                                </li>
                            </ol>
                        </nav>
                        <div class="bg-white shadow bg-body-tertiary rounded position-relative container py-3">
                            <div class="pt-2">
                                <table id="historyTable" class="hover" style="font-size: 12px">
...
<!-- get History -->
 <script>
    $(document).ready(function() {
        fetch('https://backend-folder.test/api/rider/history', {
            method: 'GET',
            headers: {
            ...
            $('#historyTable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'status',
                        render: function(data, type, row) {
                            return `<div class="text-success fw-semibold">${row.status}</div>`
                        }
                    },
                    { data: 'name' },
                    { data: 'address' },
