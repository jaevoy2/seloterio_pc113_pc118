            ...
            <div class="modal-body d-flex gap-4">
                ...
                <div class="col-5">
                    <div class="mb-3">
                        ...
                        <input type="text" name="course" class="form-control" id="editCourse">
                    </div>
                    <div class="mb-3">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('http://backend-folder.test/api/student/students', {
            method: 'GET',
            headers: {
...
<script>
    document.getElementById('addUser').addEventListener('click', function(event) {
        ...
        if(firstname && lastname && address && email && password) {
            fetch('http://backend-folder.test/api/student/add-student', {
                method: 'POST',
                headers: {
                    'Content-Type': 'Application/json',
                    'Accept': 'Application/json',
...
<script>
    $(document).on('click', '.deleteUser', function(event) {
        ...
        $(document).on('click', '#deleteBtn', function() {
            $.ajax({
                url: 'http://backend-folder.test/api/student/delete-student',
                method: 'POST',
                headers: {
...
<script>
    $(document).on('click', '.editBtn', function() {
        ...
        $('#editUser').find("input[name='course']").val(course);
        ...
        $(document).on('click', '#updateBtn', function(event) {
            ...
            fetch('http://backend-folder.test/api/student/update-student', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
