                    ...
                    <div class="d-flex gap-5">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text bg-warning text-dark rounded-0" for="gender">Gender</label>
                                </div>
                        ...
                        <div class="col-5">
                            <div class="input-group mb-1">
                                <div class="input-group-prepend">
                                    <label class="input-group-text bg-warning text-dark rounded-0" for="userCreate">Roles</label>
                                </div>
                    ...
                    <div class="d-flex gap-5">
                        ...
                        <div class="col-5">
                            <div class="input-group mb-3">
                                ...
                                <div class="d-flex align-items-center gap-1 justify-content-end text-danger mt-2" id="removeExistingProfile" style="font-size: 13px; cursor: pointer; width: 100%" data-bs-toggle="modal" data-bs-target="#removeProfileModal">
